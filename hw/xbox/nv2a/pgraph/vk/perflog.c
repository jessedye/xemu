...
static const struct {
    ...
    { NV2A_PROF_RPB_SURF_BIND,        "rpb_surf_bind" },
    ...
    { NV2A_PROF_ALIAS_REJ_DEPTH,     "alias_rej_depth" },
    { NV2A_PROF_ALIAS_REJ_TARGET,    "alias_rej_target" },
    { NV2A_PROF_ALIAS_REJ_FORMAT,    "alias_rej_format" },
