...
#define NV2A_PROF_COUNTERS_XMAC \
    ...
    _X(NV2A_PROF_NBS_UNIFORM_STAGING) \
    _X(NV2A_PROF_NBS_DESCRIPTOR_SETS) \
    _X(NV2A_PROF_NBS_FRAMEBUFFERS) \
    _X(NV2A_PROF_NBS_INLINE_STAGING) \
    _X(NV2A_PROF_NBS_COMPUTE_TEX) \
    _X(NV2A_PROF_NBS_COMPUTE_SURF) \
    _X(NV2A_PROF_RPB_FINISH) \
    _X(NV2A_PROF_RPB_SURFACE) \
    _X(NV2A_PROF_RPB_QUERY) \
    _X(NV2A_PROF_RPB_CLEAR) \
    _X(NV2A_PROF_RPB_SURF_BIND) \
    _X(NV2A_PROF_RPB_NONDRAW) \
    _X(NV2A_PROF_RPB_FB_DIRTY) \
    _X(NV2A_PROF_RPB_ND_COPY) \
    _X(NV2A_PROF_ALIAS_DOWNGRADE) \
    _X(NV2A_PROF_ALIAS_REJ_DEPTH) \
    _X(NV2A_PROF_ALIAS_REJ_TARGET) \
    _X(NV2A_PROF_ALIAS_REJ_FORMAT) \
    _X(NV2A_PROF_S2T_REJECT_DIM) \
    _X(NV2A_PROF_S2T_REJECT_LEVELS) \
    _X(NV2A_PROF_S2T_REJECT_FORMAT) \
    _X(NV2A_PROF_DL_BASE_MATCH) \
    _X(NV2A_PROF_DL_OFFSET) \
    _X(NV2A_PROF_FENCE_POLL) \
