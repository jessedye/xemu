...
/* g_use_hard_fpu is a bitmask of helper groups so a misbehaving group can
...
#define gen_helper_flds_ST0       MAP_GEN_HELPER_SOFT_HARD_G(flds_ST0, 1)
#define gen_helper_fldl_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fldl_ST0, 1)
#define gen_helper_fildl_ST0      MAP_GEN_HELPER_SOFT_HARD_G(fildl_ST0, 1)
#define gen_helper_fildll_ST0     MAP_GEN_HELPER_SOFT_HARD_G(fildll_ST0, 1)
#define gen_helper_fsts_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fsts_ST0, 1)
#define gen_helper_fstl_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fstl_ST0, 1)
#define gen_helper_fist_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fist_ST0, 1)
#define gen_helper_fistl_ST0      MAP_GEN_HELPER_SOFT_HARD_G(fistl_ST0, 1)
#define gen_helper_fistll_ST0     MAP_GEN_HELPER_SOFT_HARD_G(fistll_ST0, 1)
#define gen_helper_fistt_ST0      MAP_GEN_HELPER_SOFT_HARD_G(fistt_ST0, 1)
#define gen_helper_fisttl_ST0     MAP_GEN_HELPER_SOFT_HARD_G(fisttl_ST0, 1)
#define gen_helper_fisttll_ST0    MAP_GEN_HELPER_SOFT_HARD_G(fisttll_ST0, 1)
#define gen_helper_fldt_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fldt_ST0, 1)
#define gen_helper_fstt_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fstt_ST0, 1)
#define gen_helper_fpush          MAP_GEN_HELPER_SOFT_HARD_G(fpush, 1)
#define gen_helper_fpop           MAP_GEN_HELPER_SOFT_HARD_G(fpop, 1)
#define gen_helper_fdecstp        MAP_GEN_HELPER_SOFT_HARD_G(fdecstp, 1)
#define gen_helper_fincstp        MAP_GEN_HELPER_SOFT_HARD_G(fincstp, 1)
#define gen_helper_ffree_STN      MAP_GEN_HELPER_SOFT_HARD_G(ffree_STN, 1)
#define gen_helper_fmov_ST0_FT0   MAP_GEN_HELPER_SOFT_HARD_G(fmov_ST0_FT0, 1)
#define gen_helper_fmov_FT0_STN   MAP_GEN_HELPER_SOFT_HARD_G(fmov_FT0_STN, 1)
#define gen_helper_fmov_ST0_STN   MAP_GEN_HELPER_SOFT_HARD_G(fmov_ST0_STN, 1)
#define gen_helper_fmov_STN_ST0   MAP_GEN_HELPER_SOFT_HARD_G(fmov_STN_ST0, 1)
#define gen_helper_fxchg_ST0_STN  MAP_GEN_HELPER_SOFT_HARD_G(fxchg_ST0_STN, 1)
#define gen_helper_fcom_ST0_FT0   MAP_GEN_HELPER_SOFT_HARD_G(fcom_ST0_FT0, 4)
#define gen_helper_fucom_ST0_FT0  MAP_GEN_HELPER_SOFT_HARD_G(fucom_ST0_FT0, 4)
#define gen_helper_fcomi_ST0_FT0  MAP_GEN_HELPER_SOFT_HARD_G(fcomi_ST0_FT0, 4)
#define gen_helper_fucomi_ST0_FT0 MAP_GEN_HELPER_SOFT_HARD_G(fucomi_ST0_FT0, 4)
#define gen_helper_fadd_ST0_FT0   MAP_GEN_HELPER_SOFT_HARD_G(fadd_ST0_FT0, 2)
#define gen_helper_fmul_ST0_FT0   MAP_GEN_HELPER_SOFT_HARD_G(fmul_ST0_FT0, 2)
#define gen_helper_fsub_ST0_FT0   MAP_GEN_HELPER_SOFT_HARD_G(fsub_ST0_FT0, 2)
#define gen_helper_fsubr_ST0_FT0  MAP_GEN_HELPER_SOFT_HARD_G(fsubr_ST0_FT0, 2)
#define gen_helper_fdiv_ST0_FT0   MAP_GEN_HELPER_SOFT_HARD_G(fdiv_ST0_FT0, 2)
#define gen_helper_fdivr_ST0_FT0  MAP_GEN_HELPER_SOFT_HARD_G(fdivr_ST0_FT0, 2)
#define gen_helper_fadd_STN_ST0   MAP_GEN_HELPER_SOFT_HARD_G(fadd_STN_ST0, 2)
#define gen_helper_fmul_STN_ST0   MAP_GEN_HELPER_SOFT_HARD_G(fmul_STN_ST0, 2)
#define gen_helper_fsub_STN_ST0   MAP_GEN_HELPER_SOFT_HARD_G(fsub_STN_ST0, 2)
#define gen_helper_fsubr_STN_ST0  MAP_GEN_HELPER_SOFT_HARD_G(fsubr_STN_ST0, 2)
#define gen_helper_fdiv_STN_ST0   MAP_GEN_HELPER_SOFT_HARD_G(fdiv_STN_ST0, 2)
#define gen_helper_fdivr_STN_ST0  MAP_GEN_HELPER_SOFT_HARD_G(fdivr_STN_ST0, 2)
#define gen_helper_fchs_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fchs_ST0, 2)
#define gen_helper_fabs_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fabs_ST0, 2)
#define gen_helper_fxam_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fxam_ST0, 4)
#define gen_helper_fld1_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fld1_ST0, 1)
#define gen_helper_fldl2t_ST0     MAP_GEN_HELPER_SOFT_HARD_G(fldl2t_ST0, 1)
#define gen_helper_fldl2e_ST0     MAP_GEN_HELPER_SOFT_HARD_G(fldl2e_ST0, 1)
#define gen_helper_fldpi_ST0      MAP_GEN_HELPER_SOFT_HARD_G(fldpi_ST0, 1)
#define gen_helper_fldlg2_ST0     MAP_GEN_HELPER_SOFT_HARD_G(fldlg2_ST0, 1)
#define gen_helper_fldln2_ST0     MAP_GEN_HELPER_SOFT_HARD_G(fldln2_ST0, 1)
#define gen_helper_fldz_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fldz_ST0, 1)
#define gen_helper_fldz_FT0       MAP_GEN_HELPER_SOFT_HARD_G(fldz_FT0, 1)
#define gen_helper_fnstsw         MAP_GEN_HELPER_SOFT_HARD_G(fnstsw, 4)
#define gen_helper_fnstcw         MAP_GEN_HELPER_SOFT_HARD_G(fnstcw, 4)
#define gen_helper_fldcw          MAP_GEN_HELPER_SOFT_HARD_G(fldcw, 4)
#define gen_helper_fclex          MAP_GEN_HELPER_SOFT_HARD_G(fclex, 4)
#define gen_helper_fwait          MAP_GEN_HELPER_SOFT_HARD_G(fwait, 4)
#define gen_helper_fninit         MAP_GEN_HELPER_SOFT_HARD_G(fninit, 4)
#define gen_helper_fbld_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fbld_ST0, 1)
#define gen_helper_fbst_ST0       MAP_GEN_HELPER_SOFT_HARD_G(fbst_ST0, 1)
#define gen_helper_f2xm1          MAP_GEN_HELPER_SOFT_HARD_G(f2xm1, 8)
#define gen_helper_fyl2x          MAP_GEN_HELPER_SOFT_HARD_G(fyl2x, 8)
#define gen_helper_fptan          MAP_GEN_HELPER_SOFT_HARD_G(fptan, 8)
#define gen_helper_fpatan         MAP_GEN_HELPER_SOFT_HARD_G(fpatan, 8)
#define gen_helper_fxtract        MAP_GEN_HELPER_SOFT_HARD_G(fxtract, 8)
#define gen_helper_fprem1         MAP_GEN_HELPER_SOFT_HARD_G(fprem1, 8)
#define gen_helper_fprem          MAP_GEN_HELPER_SOFT_HARD_G(fprem, 8)
#define gen_helper_fyl2xp1        MAP_GEN_HELPER_SOFT_HARD_G(fyl2xp1, 8)
#define gen_helper_fsqrt          MAP_GEN_HELPER_SOFT_HARD_G(fsqrt, 2)
#define gen_helper_fsincos        MAP_GEN_HELPER_SOFT_HARD_G(fsincos, 8)
#define gen_helper_frndint        MAP_GEN_HELPER_SOFT_HARD_G(frndint, 8)
#define gen_helper_fscale         MAP_GEN_HELPER_SOFT_HARD_G(fscale, 8)
#define gen_helper_fsin           MAP_GEN_HELPER_SOFT_HARD_G(fsin, 8)
#define gen_helper_fcos           MAP_GEN_HELPER_SOFT_HARD_G(fcos, 8)
#define gen_helper_fstenv         MAP_GEN_HELPER_SOFT_HARD_G(fstenv, 16)
#define gen_helper_fldenv         MAP_GEN_HELPER_SOFT_HARD_G(fldenv, 16)
#define gen_helper_fsave          MAP_GEN_HELPER_SOFT_HARD_G(fsave, 16)
#define gen_helper_frstor         MAP_GEN_HELPER_SOFT_HARD_G(frstor, 16)
